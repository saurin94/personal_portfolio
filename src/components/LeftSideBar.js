        ...
        return (
            <div className="left-sidebar col-lg-1 col-md-1 ml-3 d-none d-md-block">
                ...
                <div className="item-1 mt-1">
                    <a href={"https://www.linkedin.com/in/saurin94/"} className={"side-icons"} target="_blank"
                       rel="noopener noreferrer"><i className="fab fa-linkedin fa-2x"></i></a>
                </div>
                <div className="item-1 mt-5">
                    <a href={"https://www.facebook.com/sau94"} className={"side-icons"} target="_blank"
                       rel="noopener noreferrer"><i className="fab fa-facebook-square fa-2x"></i>
                    </a>
                </div>
                <div className="item-1 mt-5">
                    <a href={"https://github.com/saurin94"} className={"side-icons"} target="_blank"
                    rel="noopener noreferrer"><i className="fab fa-github fa-2x"></i>
                    </a>
                </div>
                <div className="item-1 mt-5">
                    <a href={"https://www.instagram.com/saurin94/"} className={"side-icons"} target="_blank"
                       rel="noopener noreferrer"><i className="fab fa-instagram fa-2x"></i>
                    </a>
                </div>
            </div>
        );
